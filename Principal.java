...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("4. La hora actual local: " + fechaHoraActualMadrid.format(formatoHoraEspaña));

        DateTimeFormatter formatoHoraCaracas = DateTimeFormatter.ofPattern("HH:mm:ss");
        System.out.println("5. La hora actual en Caracas: " + fechaHoraActualCaracas.format(formatoHoraCaracas));
        ...
        System.out.println("6. Las horas de diferencia entre Madrid y Caracas: " + horasDiferencia);
        ...
        System.out.println("7. La fecha y la hora cuando Neil Armstrong pisó la luna: " + neilarmstronglunamadrid.format(formatoFechaHora));
    }
}
